  ...
  if (isset($cPath_array)) {
    for ($i=0, $n=sizeof($cPath_array); $i<$n; $i++) {
      ...
      if (tep_db_num_rows($categories_query) > 0) {
        ...
        $breadcrumb->add($categories['categories_name'], tep_href_link(FILENAME_CATALOG, 'cPath=' . implode('_', array_slice($cPath_array, 0, ($i+1)))));
      } else {
        break;
      }
    }
    ...
    if (tep_db_num_rows($manufacturers_query)) {
      ...
      $breadcrumb->add($manufacturers['manufacturers_name'], tep_href_link(FILENAME_CATALOG, 'manufacturers_id=' . $HTTP_GET_VARS['manufacturers_id']));
    }
  }
