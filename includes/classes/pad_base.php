...
*/
    function _draw_table_start() {
      ...
      $out.='            <tr>';
      $out.='             <td class="main" colspan="2"><strong>' . TEXT_PRODUCT_OPTIONS . '</strong></td>';
      $out.='            </tr>';
      return $out;
    }
/*
    ...
    function _draw_stocked_attributes() {
      ...
      if (sizeof($attributes)>0) {
        foreach ($attributes as $stocked) {
          $out .= '<tr><td align="right" class=main><strong>' . $stocked['oname'] . ":</strong></td><td class=main>" . tep_draw_pull_down_menu('id['.$stocked['oid'].']',array_values($stocked['ovals']),$stocked['default']) . "</td></tr>\n";
        }
      }
      return $out;
    }
...
*/
    function _draw_nonstocked_attributes() {
      ...
      {
        $out.='<tr><td align="right" class=main><strong>'.$nonstocked['oname'].":</strong></td><td class=main>".tep_draw_pull_down_menu('id['.$nonstocked['oid'].']',$nonstocked['ovals'],$nonstocked['default'])."</td></tr>\n";
      }
      return $out;
    }
/*
