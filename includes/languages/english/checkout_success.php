...
define('TEXT_SUCCESS', 'Your order has been successfully processed! Your products will arrive at their destination approximately within 2-8 working days. Please add "accudro.com" to your spam filter so that emails from us will not be blocked. Please note that "AccuDRO Systems" will appear on your card/bank statement.   ');
