<?php
  ...
  * @Id $Id:: article_info.php 199 2011-01-26 15:27:34Z Rob             $:  Full Details   
  */
  ...
  * @package USU5_PRO
  */
  class Article_Info_Page_Module extends aPage_Modules {
    ...
    */
    protected $dependencies = array( 'articles_id' => array( 'marker'     => '-a-',
                                                             ...
                                                             'to_replace' => array( ':TABLE_ARTICLES_DESCRIPTION', ':articles_id', ':languages_id' ) ) );
    /**
    ...
    */
    protected $cache_name_builder = array( 'articles_id' => 1 ); // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
    /**
    * Class constructor
    * @access private
    */
      ...
      */
      ...
      switch ( true ) {
        case $this->key == 'articles_id': // xxx = _GET key ( e.g. cPath )
          ...
          $this->setQuery( array( TABLE_ARTICLES_DESCRIPTION, $this->stripPathToLastNumber( $this->keys_index[$this->key] ), Usu_Main::i()->getVar( 'languages_id' ) ) );
          break;
        default:
