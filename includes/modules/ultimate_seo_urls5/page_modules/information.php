<?php
  ...
  * @Id $Id:: information.php 199 2011-01-26 15:27:34Z Rob              $:  Full Details   
  */
  ...
  * @package USU5_PRO
  */
  class Information_Page_Module extends aPage_Modules {
    ...
    */
    protected $cache_name_builder = array( 'info_id' => 1 ); // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
    /**
    * Class constructor
    * @access private
    */
      ...
      */
      ...
      switch ( true ) {
        case $this->key == 'info_id': // xxx = _GET key ( e.g. cPath )
          ...
          $this->setQuery( array( TABLE_INFORMATION, $this->stripPathToLastNumber( $this->keys_index[$this->key] ), Usu_Main::i()->getVar( 'languages_id' ) ) );
          break;
        default:
