<?php
  ...
  * @Id $Id:: links.php 199 2011-01-26 15:27:34Z Rob                    $:  Full Details   
  */
  ...
  * @package USU5_PRO
  */
  class Links_Page_Module extends aPage_Modules {
    ...
    */
    protected $dependencies = array( 'lPath' => array( 'marker'     => '-links-',
                                                       ...
                                                       'to_replace' => array( ':TABLE_LINK_CATEGORIES_DESCRIPTION', ':lPath', ':languages_id' ) ) );
    /**
    ...
    */
    protected $cache_name_builder = array( 'lPath' => 1 ); // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
    /**
    * Class constructor
    * @access private
    */
      ...
      */
      ...
      switch ( true ) {
        case $this->key == 'lPath': // xxx = _GET key ( e.g. cPath )
          ...
          $this->setQuery( array( TABLE_LINK_CATEGORIES_DESCRIPTION, $this->stripPathToLastNumber( $this->keys_index[$this->key] ), Usu_Main::i()->getVar( 'languages_id' ) ) );
          break;
        default:
