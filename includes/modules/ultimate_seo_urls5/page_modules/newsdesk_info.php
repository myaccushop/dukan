<?php
  ...
  * @Id $Id:: newsdesk_info.php 199 2011-01-26 15:27:34Z Rob            $:  Full Details   
  */
  ...
  * @package USU5_PRO
  */
  class Newsdesk_Info_Page_Module extends aPage_Modules {
    ...
    */
    protected $dependencies = array( 'newsdesk_id' => array( 'marker'     => '-n-',
                                                             ...
                                                             'to_replace' => array( ':TABLE_NEWSDESK_DESCRIPTION', ':newsdesk_id', ':languages_id' ) ) );
    /**
    ...
    */
    protected $cache_name_builder = array( 'newsdesk_id' => 1 ); // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
    /**
    * Class constructor
    * @access private
    */
