<?php
  ...
  * @Id $Id:: product_reviews.php 199 2011-01-26 15:27:34Z Rob          $:  Full Details   
  */
  ...
  * @package USU5_PRO
  */
  class Product_Reviews_Page_Module extends aPage_Modules {
    ...
    */
    protected $dependencies = array( 'products_id' => array( 'marker'     => '-pr-',
                                                             ...
                                                             'to_replace' => array( ':TABLE_PRODUCTS_DESCRIPTION', ':TABLE_PRODUCTS', ':pid', ':languages_id' ) ) );
    /**
    ...
    */
    protected $cache_name_builder = array( 'products_id' => 1 ); // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
    /**
    * Class constructor
    * @access private
    */
