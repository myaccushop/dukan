...
?>
  ...
  <?php echo tep_draw_checkbox_field('accept_legal', '1'); ?>
      I have read and accept the <a target="_blank"  href="<?php echo FILENAME_CONDITIONS; ?>"><strong>Terms and Conditions</strong><sub> (please click here to read the Terms and Conditions)</sub></a>
  </div>
<?php
